...
import { images, audios, videos } from './Data';
...
function App() {
  ...
  return (
    <div className="book-container">
      ...
      >
        {/* PORTADA */}
        <Page title="🌸 Mi diario de recuerdos 🌸" pageClass={"page book-cover start"}>
        ...
        <Page title="~ Introducción ~" number="1" pageClass={"page page-interior'"}>
          <p>
        ...
        {/* CAPITULO 1 */}
        <Page title="Capítulo 1 ~ El comienzo" number="2" pageClass={"page page-interior"}>
          <p>
        ...
        <Page number="3" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        {/* CAPITULO 2 */}
        <Page title="Capítulo 2 ~ Caballero vs Antihéroe" number="4" pageClass={"page page-interior"}>
          <p>
        ...
        <Page number="5" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        <Page number="6" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        <Page number="7" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        {/* CAPITULO 3 */}
        <Page title="Capítulo 3 ~ Mi niña angelical" number="8" pageClass={"page page-interior"}>
          <p>
        ...
        <Page number="9" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        <Page number="10" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        <Page number="11" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        {/* CAPITULO 4 */}
        <Page title="Capítulo 4 ~ Somos un gran equipo" number="12" pageClass={"page page-interior"}>
          <p>
        ...
        <Page number="13" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        <Page number="14" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        <Page number="15" pageClass={"page page-interior"}>
          <p style={{ marginTop: "10px" }}>
        ...
        {/* CAPITULO 5 */}
        <Page title="Capítulo 5 ~ Nuestro primer mes" number="16" pageClass={"page page-interior"}>
          <p>
            &emsp;Y si llegaste hasta acá quiero decirte, feliz primer mes amor, hoy 8 de junio cumplimos el primer mes de muchos. <br />
        ...
        <Page number="17" pageClass={"page page-interior"}>
